...
const FREE = [
  ...
  { ok: false, text: "Check-in Diario con racha gamificada" },
  { ok: false, text: "Check-in de Seguridad con recordatorios" },
...
const PREMIUM = [
  ...
  "Check-in Diario con racha y mensaje automático",
  "Check-in de Seguridad con recordatorios cada 1-12 hrs",
